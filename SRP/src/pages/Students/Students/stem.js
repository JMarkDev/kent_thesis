  ...
  return (
    <div className=' mx-auto  p-10 bg-blue-300 dark:bg-black'>
      <Link to="/Strands" className=" p-2 md:p-4 text-center">
        <button className="bg-gray-500 hover:bg-gray-700 text-white px-6 py-2 rounded-md absolute top-20 mt-8">
          BACK
        </button>
      </Link>
      <div
...
function TextComponent() {
  return (
    <div className="dark:bg-black bg-blue-300 h-auto p-4">
      <h2 className="text-4xl font-bold tracking-tight text-blue-600 sm:text-4 text-center mt-5">Science, Technology, Engineering, and Mathematics (STEM)</h2>
